...
@register_model
# Function to create a ViT model with custom dimensions
def create_vit(img_size=224, patch_size=16, in_channels=3, embed_dim=768, num_layers=12, num_heads=12, 
               qkv_dim=768, ff_hidden_dim=3072, output_dim=768, num_classes=1000):
